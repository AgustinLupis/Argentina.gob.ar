...
public class TC_consultarcalendario {
  ...
  @Test
  public void testTCConsultarcalendario() throws Exception {
    driver.get(baseUrl + "/");
    driver.findElement(By.cssSelector("i.fa.fa-calendar")).click();
    try {
      assertEquals("Consultar calendario de pago de ANSES | Argentina.gob.ar", driver.getTitle());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertTrue(isElementPresent(By.linkText("ANSES")));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    driver.findElement(By.linkText("ANSES")).click();
    try {
