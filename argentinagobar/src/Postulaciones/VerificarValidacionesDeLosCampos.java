...
public class VerificarValidacionesDeLosCampos {
  ...
  public void testAltaSinAdjunto() throws Exception {
    ...
    driver.findElement(By.id("edit-nombres")).sendKeys("123123");
    driver.findElement(By.id("edit-apellido")).clear();
    driver.findElement(By.id("edit-apellido")).sendKeys("123123");
    driver.findElement(By.id("edit-telefono")).clear();
    driver.findElement(By.id("edit-telefono")).sendKeys("asdasd");
    driver.findElement(By.id("edit-dni")).clear();
    driver.findElement(By.id("edit-dni")).sendKeys("asdasd");
    driver.findElement(By.id("edit-mail")).clear();
    driver.findElement(By.id("edit-mail")).sendKeys("asdasdasd");
    ...
    driver.findElement(By.id("edit-localidad")).sendKeys("123123132");
    ...
    boolean a = driver.getPageSource().contains("Solo se pueden ingaresar letras y espacios en el campo");
    assertTrue(a);
    boolean b = driver.getPageSource().contains("Solo se pueden ingaresar letras y espacios en el campo");
    assertTrue(b);
    boolean c = driver.getPageSource().contains("sólo admite números.");
    assertTrue(c);
    boolean d = driver.getPageSource().contains(" sólo admite números.");
    assertTrue(d);
    boolean e = driver.getPageSource().contains(" no es válido.");
    assertTrue(e);    
    System.out.println("Taking Screen Shot");
	File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
	FileUtils.copyFile(screenshot, new File("/home/aluna/Desktop/capturas/postulaciones/testingv2/capturas/VerificarValidacionesDeLosCampos.png"));
  }
