...
public class AgregarEstudio {
  ...
  public void testAltaSinAdjunto() throws Exception {
    ...
    assertTrue(isElementPresent(By.id("edit-nivel-de-estudio2")));
    assertTrue(isElementPresent(By.id("edit-estado-cursada2")));
    assertTrue(isElementPresent(By.id("edit-titulo-obtenido2")));
	...
	FileUtils.copyFile(screenshot, new File("/home/nicolas/Capturas/agregarestudio.png"));	
