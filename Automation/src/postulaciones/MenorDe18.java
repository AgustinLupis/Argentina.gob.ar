...
public class MenorDe18 {
  ...
  public void testAltaSinAdjunto() throws Exception {
    ...
    new Select(driver.findElement(By.id("edit-fecha-nacimiento-month"))).selectByVisibleText("Feb");
    new Select(driver.findElement(By.id("edit-fecha-nacimiento-day"))).selectByVisibleText("5");
    new Select(driver.findElement(By.id("edit-fecha-nacimiento-year"))).selectByVisibleText("2000");
	...
	FileUtils.copyFile(screenshot, new File("/home/nicolas/Capturas/Postulaciones/menorde18.png"));	
